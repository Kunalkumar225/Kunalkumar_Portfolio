    ...
    return (
        <section className="relative w-full h-screen min-h-[850px] flex items-center justify-center overflow-hidden bg-primary text-text-primary font-sans pt-20">
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="w-full max-w-7xl mx-auto px-6 lg:px-12 relative z-10 h-full flex items-center"
            >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 w-full">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center order-2 lg:order-1 relative z-20">
                        ...
                        >
                            <span className="text-accent bg-accent/10 px-3 py-1 rounded-lg border border-accent/20 hover:bg-accent/20 transition-colors duration-300">Backend Engineer</span>
                            <span className="text-text-muted opacity-50">•</span>
                            <span className="hover:text-text-primary transition-colors duration-300">Critical Thinker</span>
                            <span className="text-text-muted opacity-50">•</span>
                            <span className="hover:text-text-primary transition-colors duration-300">System Design</span>
                            <span className="text-text-muted opacity-50">•</span>
                            <span className="hover:text-text-primary transition-colors duration-300">DSA Solver</span>
                        </motion.div>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
                                <button onClick={handleScrollToProjects} className="btn-primary w-full sm:w-auto text-[15px] px-8 h-[52px] flex items-center justify-center group/btn relative overflow-hidden">
                                    <span className="relative z-10">Explore Work</span>
                                    <div className="absolute inset-0 bg-white/10 translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300" />
                                </button>
                                <a href="https://drive.google.com/file/d/1gNBBK2EIAXu_j8fkvhGv_hkOJzHnz389/view" target="_blank" rel="noreferrer" className="btn-outline w-full sm:w-auto text-[15px] px-8 h-[52px] flex items-center justify-center group/btn relative overflow-hidden">
                    ...
                    <div className="lg:col-span-5 flex justify-center lg:justify-end items-center order-1 lg:order-2">
                        ...
                        >
                            ...
                            <div className="relative w-full h-full rounded-3xl border border-glass-border bg-glass-tint backdrop-blur-3xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.1)] p-8 transition-all duration-normal ease-apple group-hover:border-glass-light flex flex-col justify-between transform-gpu">
            ...
            >
                <span className="text-[10px] text-text-muted uppercase tracking-[0.2em] font-mono animate-pulse">Scroll to explore</span>
